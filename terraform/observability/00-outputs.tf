...
output "logstash_endpoint" {
  ...
  value       = "http://${module.app_load_balancer.alb_dns_name}:9600"
}

output "logstash_ingest_endpoint" {
  description = "The public HTTP endpoint for sending logs to Logstash."
  value       = "http://${module.app_load_balancer.alb_dns_name}:8080"
}
